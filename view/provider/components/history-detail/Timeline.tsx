        ...
        <div className="bg-stone-50 dark:bg-stone-900/50 p-6 rounded-[2rem] border border-stone-200 dark:border-stone-800">
            ...
            <div className="relative pl-4 space-y-8 border-l-2 border-stone-200 dark:border-stone-700 ml-2">
                <div className="relative">
                    ...
                    <p className="text-xs text-stone-500 font-mono mb-0.5">{timestamps.claimedAt}</p>
                ...
                {timestamps.pickedUpAt && (
                    <div className="relative">
                        ...
                        <p className="text-xs text-stone-500 font-mono mb-0.5">{timestamps.pickedUpAt}</p>
                ...
                <div className="relative">
                    ...
                    <p className="text-xs text-stone-500 font-mono mb-0.5">{timestamps.completedAt}</p>
