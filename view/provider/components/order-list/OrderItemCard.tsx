...
export const OrderItemCard: React.FC<OrderItemCardProps> = ({ order, onClick }) => (
    ...
    >
        ...
        <div className="space-y-2 border-t border-stone-100 dark:border-stone-800 pt-3 pl-2">
            ...
            <div className="flex justify-between items-center text-xs">
                <span className="text-stone-500 flex items-center gap-1"><Clock className="w-3 h-3" /> Waktu Klaim</span>
                <span className="font-mono text-stone-900 dark:text-white">{order.timestamps.claimedAt}</span>
            </div>
        </div>
