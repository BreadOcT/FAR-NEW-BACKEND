...
import { Package, Search, ArrowLeft, Upload, Loader2, ArrowRight, ShieldCheck, Zap, CheckCircle2, AlertCircle, Clock, Thermometer, List, Info, ChevronRight, Sparkles, MessageSquareQuote, FileSearch, Calendar, ChevronLeft } from 'lucide-react';
...
export const InventoryManager: React.FC = () => {
  ...
  useEffect(() => {
    // Generate dummy data > 10 items to test pagination
  ...
  if (isAddingNew) {
      return (
        // ... (Existing adding new item UI remains unchanged, just returning standard UI wrapper for brevity if user didn't ask to change this part deeply)
        // I will copy the content exactly from original file for the `isAddingNew` block to ensure no code loss
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-stone-200 dark:border-stone-800">
                        ...
                        <div className="flex items-center gap-2">
                            <button 
                                ...
                                className="p-2 rounded-lg bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 hover:bg-stone-50 dark:hover:bg-stone-800 disabled:opacity-50"
                            >
