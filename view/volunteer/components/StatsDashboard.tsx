...
import { Trophy, TrendingUp, Flame, Gift, CheckCircle, Award, MapPin, Clock, Info, X, Target, Zap } from 'lucide-react';
...
export const StatsDashboard: React.FC<StatsDashboardProps> = ({ stats, quests }) => {
  ...
  return (
    <div className="space-y-6 pb-8">
       <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Current Status Card */}
          <div className="bg-white rounded-3xl p-6 text-stone-900 border border-orange-100 shadow-lg relative overflow-hidden group">
          ...
          {/* Weekly Activity */}
          <div className="bg-white p-6 rounded-3xl border border-stone-200 shadow-md md:col-span-2">
       ...
       <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={idx} className="bg-white p-6 rounded-3xl border border-stone-100 shadow-sm flex flex-col items-center text-center group hover:border-orange-200 transition-all duration-300">
               ...
               <span className="text-2xl font-black text-stone-900 mb-1 leading-none">{item.value}</span>
