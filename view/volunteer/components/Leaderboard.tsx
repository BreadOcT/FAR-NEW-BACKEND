             ...
             <div className="bg-[#EF6C00] rounded-[2rem] p-6 text-white text-center shadow-lg relative overflow-hidden">
                ...
                <div className="flex items-end justify-center gap-2 md:gap-4 px-2 pb-2">
                    ...
                    <div className="flex flex-col items-center flex-1 max-w-[100px] animate-in slide-in-from-bottom-8 duration-700">
                        <div className="w-12 h-12 md:w-16 md:h-16 rounded-full border-2 border-blue-200 bg-orange-400/50 backdrop-blur-md mb-3 flex items-center justify-center font-bold text-lg shadow-lg">
                            {top2?.avatar}
                        </div>
                    ...
                    <div className="flex flex-col items-center flex-1 max-w-[120px] -mb-1 animate-in slide-in-from-bottom-12 duration-1000">
                         <div className="relative mb-3">
                            ...
                            <div className="w-16 h-16 md:w-20 md:h-20 rounded-full border-4 border-yellow-400 bg-orange-400 flex items-center justify-center font-black text-xl md:text-2xl shadow-xl ring-4 ring-orange-500/30">
                                {top1?.avatar}
                            </div>
                         </div>
                    ...
                    <div className="flex flex-col items-center flex-1 max-w-[100px] animate-in slide-in-from-bottom-6 duration-500">
                        <div className="w-12 h-12 md:w-16 md:h-16 rounded-full border-2 border-orange-200/50 bg-orange-400/50 backdrop-blur-md mb-3 flex items-center justify-center font-bold text-lg shadow-lg">
                            {top3?.avatar}
                        </div>
             ...
             <div className="bg-white rounded-3xl border border-stone-100 shadow-sm overflow-hidden">
                 {others.map((user) => (
                     <div key={user.id} className="flex items-center p-5 border-b border-stone-50 last:border-0 hover:bg-stone-50 transition-colors group">
                         ...
                         <div className="w-10 h-10 rounded-full bg-stone-100 border border-stone-100 flex items-center justify-center font-bold text-xs text-stone-500 mr-4 shadow-sm">
                             {user.avatar}
                         </div>
